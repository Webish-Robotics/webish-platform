...
export default class GuestException extends Exception {
  /**
   ...
   * @param redirectTo
   */
  constructor(message: string, http: number, code: string, protected redirectTo: string) {
  ...
  public async handle(error: this,  ctx: HttpContextContract) {
    ...
    ctx.session.flash('guest', {error: error.message})
